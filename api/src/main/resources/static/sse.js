...
//			// Find closest existing event source
//			console.log("Found something: " + child.id)
...
//
//		var swapSpec = api.getSwapSpecification(elt);
//		console.log("swapSpec: " + JSON.stringify(swapSpec));
//		var target = api.getTarget(elt);
